...
class ModeloAgro{
	...
	static public function mdlCargarArchivo($tabla,$data){
		...
		if($tabla == 'planificacion'){
			...
			$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(campania1,campania2,campo,lote,has,fina,costoFina,gruesa,costoGruesa,periodoTime) VALUES campania1,:campania2,:campo,:lote,:has,:fina,:costoFina,:gruesa,:costoGruesa,:periodoTime");
